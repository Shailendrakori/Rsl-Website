        ...
        <Box className="overlay">
          <Grid container sx={{ paddingTop: "10%" }}>
            ...
            <Grid md={7} xs={12} className="wellcome-to">
              <Typography className="h3-home" container variant="h2">
        ...
        <Grid container sx={{ mt: "5%" }}>
          ...
          <Grid md={6} xs={12}>
            <Box sx={{ p: "3%" }}>
              ...
              >
                <Box>
                  Their multi-disciplined skills are always up in solving the
                  big problems and hurdles that come in the path.
                </Box>
              </Typography>
              <Typography
                variant="h5"
