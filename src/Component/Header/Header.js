...
const Header = () => {
    ...
    return (
        <>
            <CssBaseline />
            <AppBar position="fixed" className="navbar-bg" sx={{backgroundColor:"white"}}>
                    ...
                    <Toolbar disableGutters>
                        ...
                        <Box sx={{ flexGrow: 1, display: { xs: 'flex', md: 'none' } }}>
                            ...
                            >
                                ...
                                <MenuItem onClick={handleCloseNavMenu}>
                                    <Typography textAlign="center"> <Link to="/services" >Services</Link></Typography>
                                </MenuItem>
                                <MenuItem onClick={handleCloseNavMenu}>
                                    <Typography textAlign="center"> <Link to="/portfolio" >Portfolio</Link></Typography>
                                </MenuItem>
                                <MenuItem onClick={handleCloseNavMenu}>
                        ...
                        <Box   sx={{ flexGrow: 2,justifyContent:"end", display: { xs: 'none', md: 'flex' } }}>
                            {/* {pages.map((page) => (
                                <Button
                                    key={page}
